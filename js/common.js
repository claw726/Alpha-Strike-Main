...
import { initializeLanguageSwitcher, languages, setLanguage } from './translation-dictionary.js';
...
export function displayDataInContainer(data, containerId, createCardFn, options = {}) {
  ...
  if (options.sortBy && options.sortDirection) {
    data.sort((a, b) => {
      ...
      const valA =
        a && typeof a === 'object' && Object.prototype.hasOwnProperty.call(a, options.sortBy)
          ? a[options.sortBy]
          : undefined;
      const valB =
        b && typeof b === 'object' && Object.prototype.hasOwnProperty.call(b, options.sortBy)
          ? b[options.sortBy]
          : undefined;
